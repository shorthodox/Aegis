                ...
                if _reversal_flip or cooldown_elapsed >= required_cooldown:
                    ...
                    if USE_WEIGHTED_SCORER:
                        ...
                        try:
                            ...
                            _lvls_m = []
                        if new_side == 'BUY':
                            _cand_m  = [l for l, _t in _lvls_m if l < price]
                            _target_m = max(_cand_m) if _cand_m else None
                            _role_m  = 'support'
                        else:
                            _cand_m  = [l for l, _t in _lvls_m if l > price]
                            _target_m = min(_cand_m) if _cand_m else None
                            _role_m  = 'resistance'
