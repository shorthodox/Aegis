...
"""
    ...
    def save_json_outputs(self) -> None:
        outputs = {
            "feature_drift.json":    self.sections.get("s2", {}),
            "meta_forensics.json":   self.sections.get("s5", {}),
            "regime_forensics.json": self.sections.get("s6", {}),
            "quality_forensics.json":self.sections.get("s8", {}),
            "execution_forensics.json": {
...
def run_forensics(symbol: str = "BTC/USDT") -> Path:
    print(f"\n{'='*60}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--symbol", default="BTC/USDT", help="Symbol to audit")
