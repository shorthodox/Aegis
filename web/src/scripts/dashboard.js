...
function _renderFpConfluence(body, signal, tier) {
  ...
  const lockOverlay = locked ? `
    <div class="absolute inset-0 bg-black/80 backdrop-blur-md rounded-xl flex flex-col items-center justify-center z-10">
      ...
      <a href="/src/pages/pricing.html" class="px-6 py-2 bg-gradient-to-r from-cyan to-blue-600 text-white font-bold rounded-xl text-sm">Upgrade Now</a>
    </div>` : '';
...
function _renderFpZones(body, signal, tier) {
  ...
  const lockOverlay = locked ? `
    <div class="absolute inset-0 bg-black/80 backdrop-blur-md rounded-xl flex flex-col items-center justify-center z-10">
      <i class="fas fa-lock text-3xl text-gray-500 mb-3"></i>
      <h3 class="text-lg font-bold text-white mb-1">Intermediate Plan Required</h3>
      <a href="/src/pages/pricing.html" class="px-6 py-2 bg-gradient-to-r from-cyan to-blue-600 text-white font-bold rounded-xl text-sm mt-2">Upgrade Now</a>
    </div>` : '';
...
function _renderFpExpectancy(body, signal, tier) {
  ...
  const lockOverlay = locked ? `
    <div class="absolute inset-0 bg-black/80 backdrop-blur-md rounded-xl flex flex-col items-center justify-center z-10">
      ...
      <a href="/src/pages/pricing.html" class="px-6 py-2 bg-gradient-to-r from-amber-500 to-orange text-white font-bold rounded-xl text-sm">Upgrade to Pro</a>
    </div>` : '';
