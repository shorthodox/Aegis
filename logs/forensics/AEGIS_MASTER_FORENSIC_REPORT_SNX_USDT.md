...
**Symbol:** SNX/USDT  |  **Generated:** 2026-06-07 16:39:38
...
> Measured precision is 34.0% — estimated 5.6pp below achievable ceiling of ~39.6%. Primary contributors: Brier score above target (−2.0pp), Barrier skew suppresses BUY labels (−1.5pp), HOLD over-representation in labels (−1.7pp)
...
Achievable precision       :  ~39.6%  (+5.6pp precision)
...
✅ **5. tradeable_buy_holdout = True**
   ...
   - Value: buy_h_n=26, buy_win_rate=73.1%
   - PASS — 26 trades, 73.1% WR.
...
| OOF → Holdout gap | +48.2pp |
| thr_buy / thr_sell | 48.052 / 47.760 |
| Blocked signals | 0 (91 would-win / 79 would-lose) |

> ⚠ Gate is DESTROYING 19.8pp of precision. Blocked signals (53.8%) would have beaten gated (34.0%). Meta model is anti-selective. | OOF overfit warning: dev_prec (82.3%) exceeds holdout (34.0%) by 48.2pp.
...
**Symbol:** SNX/USDT  |  **Audit:** 2026-06-07 16:39  |  **Confidence Level:** MEDIUM — based on 47 holdout signals; widen to 200+ for HIGH

**Current:** Precision=34.0%  Sharpe=20.92
...
| Dev OOF Precision | 82.3% | ✓ |
| Holdout Precision | 34.0% | ✗ |
| Holdout Coverage | 39.5% | ✓ |
| 95% CI Precision | [30.1%, 38.2%] | — |
| OOF→Holdout Gap | -48.2% | ⚠ degradation |
| Holdout Fired | 529 trades | ✓ |
| SELL Win Rate | 81.7% (197 trades) | ✓ |
| BUY Win Rate | 73.1% (26 trades) | ✓ |
| Sharpe (annualised) | 20.92 | ✓ |
| Max Drawdown | 233.32% | ✗ |
| Profit Factor | 3.07 | ✓ |
| Kelly Fraction | 25.0% | — |
| Expectancy/Trade | +0.4022% | ✓ |
...
| Statistical Sig. | p=0.0000 (z=-7.35) | ✓ significant |

### Class Distribution
- HOLD: **61.3%** — ⚠ severe imbalance
- SELL: **23.8%**
- BUY:  **14.9%** — ⚠ minority class
...
|--------|---------|-----------|------------|----------|-----------|
| meta_gate | 170 | 91 | 79 | 53.8% | +116.97% |
...
|--------|-------|--------|--------|
| ECE (before cal.) | 0.0662 | <0.10 | ✓ |
| ECE (after cal.)  | 0.0000 | <0.10 | ✓ |
| Brier Score | 0.3328 | <0.25 | ✗ |
| Cal. Temperature | 1.1991 | ~1.0 | ⚠ model overconfident |
...
**Recommended calibrator (for 389 dev samples):** `isotonic`
...
| Confidence Drift | 🟡 WARNING | T=1.199 |
| Prediction Drift | 🔴 CRITICAL | OOF vs holdout gap: +48.24pp |
...
| Holdout Sharpe | 20.92 | ✓ |
| Holdout Max DD | 233.32% | ✗ |
...
| 2 | 🟡 **Severe Class Imbalance (HOLD dominates)** | Training Quality | 61/100 | `scripts/retrain_model.py:836` ✅ FIXED | HOLD=61.3% of labels. Meta model sees 60% zero-labels → calibration di… |
...
| Metric | Value |
|--------|-------|
| Selected signals | 529 |
| Rejected signals | 810 |
| Selected precision | 34.0% |
| Rejected precision | 22.7% |
| Meta gate lift (precision) | +11.3% |
| Selected expectancy | +0.402% |
| Rejected expectancy | +0.028% |
| Selected Sharpe | +30.10 |
| Rejected Sharpe | +2.26 |
...
|--------|--------|---------|---------|----------|--------|-----------|---------|
| ACCUMULATION         | ✅ | ✅ | 48.1 | 47.8 | ✅ ENABLED | 60.0% | 1.25 |
| CHOPPY               | ✅ | ✅ | 48.1 | 47.8 | ✅ ENABLED | 60.0% | 1.25 |
| COMPRESSION          | ✅ | ✅ | 48.1 | 47.8 | ✅ ENABLED | 60.0% | 1.25 |
| DISTRIBUTION         | ✅ | ✅ | 48.1 | 47.8 | ✅ ENABLED | 60.0% | 1.25 |
| TRENDING_BEAR        | ✅ | ✅ | 48.1 | 47.8 | ✅ ENABLED | 60.0% | 1.25 |
| TRENDING_BULL        | ✅ | ✅ | 48.1 | 47.8 | ✅ ENABLED | 60.0% | 1.25 |
| VOLATILE_EXPANSION   | ✅ | ✅ | 48.1 | 47.8 | ✅ ENABLED | 60.0% | 1.25 |
...
## Section 19 — Deep SNX/USDT vs BTC/ETH Comparison
